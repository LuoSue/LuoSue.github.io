    ...
    var sure = function () {
        ...
        secondpart = function () {
            botui.message.add({
                ...
                botui.message.add({
                    delay: 1500,
                    content: "高中的时候很喜欢化学，却“误入”了计算机专业......"
                }).then(function () {
                    botui.message.add({
                        delay: 1200,
                        content: "计算机和化学一样，都是创造与改变，我很喜欢"
                    }).then(function () {
                        botui.message.add({
                            delay: 1500,
                            content: "主攻Java，虽然初心是C++，目前正在学HTML/CSS/JavaScript/PHP/Python"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "希望能够一直做自己喜欢的事"
                            }).then(function () {
                                botui.message.add({
                                    delay: 1800,
                                    content: "对音乐有一点爱好，希望能够演奏出激动人心的作品"
                                }).then(function () {
                                    botui.action.button({
                                        delay: 1100,
                                        action: [{
        ...
        thirdpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "这起源于我小时候一个外号“茄子”，落苏(LuoSue)是茄子的别名"
            }).then(function () {
                botui.action.button({
                    delay: 1500,
                    action: [{
        ...
        fourthpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "emmmm，名字最后一个字方言口音就很像茄，所以就这么叫了"
            }).then(function () {
                botui.message.add({
                    delay: 1600,
